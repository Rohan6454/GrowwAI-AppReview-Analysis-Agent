...
def approve(action: str, payload: dict) -> bool:
    ...
    # Auto-approve in deployment (Railway sets RAILWAY_ENVIRONMENT, Render sets RENDER)
    if os.getenv("AUTO_APPROVE", "false").lower() == "true" or os.getenv("RENDER") or os.getenv("RAILWAY_ENVIRONMENT"):
